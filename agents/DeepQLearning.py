...
class DQNAgent():
    def __init__(self, state_size, action_size, hidden_dim=64, gamma=0.99, epsilon=1.0, epsilon_min=0.1, epsilon_decay=0.998, lr=1e-3, tau=0.001, buffer_size=100000, batch_size=128):
